...
const sream_handlers_1 = require("../../core/hendlers/sream.handlers");
const promt_service_1 = require("../../core/promt/promt.service");
...
class FfmpegExecutor extends command_executor_1.CommandExecutor {
    constructor(logger) {
        ...
        this.promptService = new promt_service_1.PromptService();
    }
    prompt() {
    ...
    processStream(stream, logger) {
        const handler = new sream_handlers_1.StreamHandler(logger);
